    ...
    return (
        <div>
            ...
            className='flex border-2 active:border-black mb-2 rounded-xl w-full p-3 items-center justify-between'>
                ...
                <div className=' w-1/2'>
                    <h4 className='font-medium text-base'>DriveGo <span><i className="ri-user-3-fill"></i>4</span></h4>
            ...
            className='flex border-2 active:border-black mb-2 rounded-xl w-full p-3 items-center justify-between'>
                ...
                <h2 className='text-lg font-semibold'>₹53.0</h2>
            </div>
            <div  onClick={()=>{
                props.setConfirmRidePanel(true)
            }}
            className='flex border-2 active:border-black mb-2 rounded-xl w-full p-3 items-center justify-between'>
                ...
                <h2 className='text-lg font-semibold'>₹126.80</h2>
            </div>
        </div>
    )
}
